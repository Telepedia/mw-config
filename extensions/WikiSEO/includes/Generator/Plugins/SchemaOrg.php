...
class SchemaOrg extends AbstractBaseGenerator implements GeneratorInterface {
	...
	public function addMetadata(): void {
		...
		$meta['publisher'] = $this->getPublisherMetadata();
    ...
    private function getPublisherMetadata(): array {
        $sitename = $this->getConfigValue( 'Sitename' ) ?? '';
        $server = $this->getConfigValue( 'Server' ) ?? '';
        ...
        return [
            ...
            'name' => 'Telepedia',
            'url' => $server,
            'logo' => 'https://meta.telepedia.net/images/metawiki/1/14/Telepedia_Logo.svg',
        ];
    }
