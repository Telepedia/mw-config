...
class ShoutWikiAds {
	...
	private static function canShowAds( User $user ) {
		...
		if (
			...
			in_array( 'sysop', $effectiveGroups ) && !$wgRequest->getVal( 'forceads' )
		) {
			return false;
		}
	...
	public static function getBannerHTML() {
		...
		if ( isset( $wgAdConfig['debug'] ) && $wgAdConfig['debug'] === true ) {
			return '<!-- Begin banner ad (TelepediaAds) -->
...
//--></script>';
	...
	public static function getSquareHTML() {
		...
		if ( isset( $wgAdConfig['debug'] ) && $wgAdConfig['debug'] === true ) {
			return '<!-- Begin square ad (TelepediaAds) -->
...
<div id="p-ads-left" class="noprint"><div id="ezoic-pub-ad-placeholder-106">' . $adHTML . '</div></div>
</div><!-- End toolbox ad (TelepediaAds) -->' . "\n";
	}
	...
	public static function getSkyscraperHTML() {
		...
		if ( isset( $wgAdConfig['debug'] ) && $wgAdConfig['debug'] === true ) {
			return "\n" . '<!-- Begin skyscraper ad (TelepediaAds) -->
...
<!-- End skyscraper ad (TelepediaAds) -->' . "\n";
		}
...
<div id="column-google" class="' . $skinName . '-ad noprint"><div id="ezoic-pub-ad-placeholder-106">' . $adHTML . '</div>
...
<!-- End wide skyscraper ad (TelepediaAds) -->' . "\n";
	...
	public static function getSmallSquareHTML() {
		...
		if ( isset( $wgAdConfig['debug'] ) && $wgAdConfig['debug'] === true ) {
			...
			*/
			return "\n" . '<!-- Begin small square (TelepediaAds) -->
...
//--></script>';
		...
		return "\n" . '<!-- Begin small square ad (TelepediaAds) -->
<div id="small-square-ad" class="' . $skinName . '-ad noprint">' . $adHTML . '</div>
<!-- End small square ad (TelepediaAds) -->' . "\n";
	}
	...
	public static function renderTruglassAd() {
		...
		if (
			...
			echo '<!-- Begin Truglass ad (TelepediaAds) -->
