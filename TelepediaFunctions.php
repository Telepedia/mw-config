...
class TelepediaFunctions {
	...
	public static function setupHooks() {
		...
		$wgHooks['CreateWikiJsonGenerateDatabaseList'][] = 'TelepediaFunctions::onGenerateDatabaseLists';
		$wgHooks['MediaWikiServices'][] = 'TelepediaFunctions::onMediaWikiServices';
	}
	...
	public function loadExtensions() {
		...
		if ( !file_exists( self::CACHE_DIRECTORY . '/extension-list.json' ) ) {
			$queue = array_fill_keys( array_merge(
				glob( '/prod/mediawiki/extensions/*/extension*.json' ),
				glob( '/prod/mediawiki/skins/*/skin.json' )
			),
				true );
